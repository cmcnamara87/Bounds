//
//  CMUpdatesTableViewController.m
//  Bounds
//
...
@implementation CMUpdatesTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // get out the update
    CMUpdateResource *update = [self.updates objectAtIndex:indexPath.row];
    cell.textLabel.text = [[update.data objectForKey:@"place"] objectForKey:@"name"];
    cell.detailTextLabel.text = [[update.data objectForKey:@"user"] objectForKey:@"name"];
